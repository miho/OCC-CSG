...
- FreeType: if freetype cannot be found on Ubuntu then install libfreetype6-dev, we use freetype-2.7 on Windows, on macOS freetype can be installed via `brew install freetype` 
